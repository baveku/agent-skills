...
- **Slash commands** (`.claude/commands/*.md` for Claude Code; `antigravity/skills/<alias>/SKILL.md` aliases for Antigravity) — user-facing entry points. The *when*. The orchestration layer.
