...
| **Tooling reach** | Multi-tool: Claude Code, Cursor, Antigravity, OpenCode, Windsurf, Copilot, Codex | Multi-tool: Claude Code, Codex, OpenCode, Cursor, Copilot CLI, Factory Droid | Claude Code-first (also usable with Codex) |
